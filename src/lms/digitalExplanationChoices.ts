...
const SPECS: readonly ExplanationSpec[] = [
  ...
  },
  {
    ...
    correct: 'כי התנאים אומרים רק ש־x חיובי ו־y חיובי, ויש הרבה זוגות סדורים שונים שמקיימים את שניהם.',
    options: [
      'כי התנאים אומרים רק ש־x חיובי ו־y חיובי, ויש הרבה זוגות סדורים שונים שמקיימים את שניהם.',
