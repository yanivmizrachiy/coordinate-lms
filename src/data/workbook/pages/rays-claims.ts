...
<p>בעיר חדשה כל הרחובות ישרים ומקבילים לצירים. רחוב האורן יוצא ממרכז העיר — ראשית הצירים — ועובר דרך הכיכר שבנקודה ${ltr('(6,0)')}. מתכננים רחוב חדש שייצא ממרכז העיר וייצור עם רחוב האורן זווית ישרה.</p>
<ul class="tasks compact">
