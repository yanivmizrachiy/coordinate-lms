...
<p>בדקו כמה דקות אתם מקדישים לשיעורי בית בכל יום, במשך שישה ימים. סמנו נקודה לכל יום: ערך ה־${ltr('x')} מייצג את היום, ושיעור ה־${ltr('y')} מייצג את הדקות בעשרות.</p>
${grid({
  size: 'lg',
  axisX: 'יום',
  axisY: 'דקות (עשרות)',
...
<li>ההפרש בין מספר הדקות הגדול ביותר ובין מספר הדקות הקטן ביותר הוא ${blank(3, 'number')} עשרות דקות.</li>
