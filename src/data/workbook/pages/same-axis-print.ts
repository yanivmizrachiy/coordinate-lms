...
/* אותו x או אותו y — הגרסה המודפסת. הדף הזה החליף שעשועון מקוון שבו בוחרים
   ...
   זיהוי הנקודות שחולקות שיעור x (קו אנכי) או שיעור y (קו אופקי) עם נקודה
   נתונה — עכשיו בעיפרון.

   מה שהיה לחיצה הוא עכשיו עיגול: במקום לבחור נקודה בלחיצה מקיפים אותה,
   ובמקום אות שנחשפת אחרי „בדקו" האות כתובה על הנקודה עצמה. ארבע הנקודות
   שמקיפים נושאות את אותיות המילה „זהים" — ז ו־ה בסעיף א, מלמעלה למטה,
   י ו־ם בסעיף ב, מימין לשמאל — והמילה נכתבת בסוף.

   הסיבובים לקוחים מ־`sameAxis.ts`: הנקודה המסומנת (3,1) לשיעור x זהה,
   והנקודה המסומנת (2,2) לשיעור y זהה. בכל סרטוט, אחד המסיחים חולק עם
   הנקודה המסומנת דווקא את השיעור האחר — מי שלא בדק, נופל בו. */
