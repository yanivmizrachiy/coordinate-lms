...
<div class="completion-sentence">בגרף של נתונים, שיעור ה־${ltr('x')} אומר <b>מתי</b> או <b>כמה</b>, ושיעור ה־${ltr('y')} אומר את ה${blank(6, 'concept')} שהתקבלה.</div>
...
<li>לשתי הנקודות ${ltr('D')} ו־${ltr('E')} יש שיעור ${ltr('y')} זהה, אבל שיעור ה־${ltr('x')} של הנקודה ${ltr('E')} ${blank(5, 'relation')}.</li>
</ul>
</section>
<section class="q-card">
...
<ul class="tasks compact">
<li>ככל ששיעור ה־${ltr('x')} גדל, שיעור ה־${ltr('y')} בדרך כלל ${blank(5, 'relation')}.</li>
<li>ההפרש בין שיעור ה־${ltr('y')} של הנקודה ${ltr('F')} ובין שיעור ה־${ltr('y')} של הנקודה ${ltr('A')} מחושב כך:</li>
</ul>
${exerciseGiven('', '6 − 2', 'שאלות')}
<ul class="tasks compact">
<li>סמנו על הגרף נקודה ${ltr('G')} של תלמיד שלמד 50 דקות ופתר 4 שאלות: ${pair('G')}.</li>
<li>הנקודה ${ltr('G')} ממוקמת מימין לנקודה ${ltr('D')} וגם ${blank(5, 'direction')} לה.</li>
</ul>
</section>
`,
});
