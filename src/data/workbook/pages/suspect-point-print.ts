...
/* הנקודה החשודה — הגרסה המודפסת. הדף הזה החליף שעשועון מקוון שבו לוחצים על
   שבב של נקודה ומקבל „✓ נכון": יניב — „המשימות שלנו הן להדפסה!!" (31.07.2026,
   כמו „מילת הצופן", „ציור נסתר" ו„פענוח צבעוני"). אותה מיומנות בדיוק —
   בודקים כל נקודה מול רמזים על שיעור ה־x ועל שיעור ה־y עד שנשארת נקודה אחת
   שמתאימה לכולם — עכשיו בעיפרון: מותחים קו על נקודה שנפסלה במקום לוותר עליה
   על המסך, ומקיפים את הנקודה שנשארה במקום ללחוץ עליה. במקום „✓ נכון" של
   השעשועון, התלמיד כותב את הזוג הסדור של הנקודה שהקיף.

   שש הנקודות והרמזים מגיעים מ־`suspectPoint.ts`: ‏A(2,3) · B(5,3) · C(5,1) ·
   D(2,1) · E(4,5) · F(7,2). בכל סיבוב שני רמזים, ובדיוק נקודה אחת מתאימה
   לשניהם — B בסיבוב 1, ו־F בסיבוב 2. */
