...
export function welcome({ outlet, setTitle }: ViewContext): (() => void) {
  ...
  /* Keep the established site directly below the mandatory full-screen intro.
     It stays a separate lazy chunk, so the explanation paints first and does
     not pull the workbook/Firebase into the entry bundle. */
