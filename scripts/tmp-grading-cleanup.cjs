...
function replaceOrAlready(path, from, to) {
  ...
  if (!src.includes(from)) {
    throw new Error(`Expected text not found in ${path}: ${from.slice(0, 180)}`);
  }
...
replaceOrAlready(
  'docs/CLASSROOM_LAUNCH_CHECKLIST.md',
